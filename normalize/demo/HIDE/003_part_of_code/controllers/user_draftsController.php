...
class user_draftsController extends BaseController
{

    // http://localhost:8081/user_drafts/select
    ...
    // http://localhost:8081/user_drafts/create
    ...
    // http://localhost:8081/user_drafts/update/:id
