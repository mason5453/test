...
class user_collectionsController extends BaseController
{

    // http://localhost:8081/user_collections/select
    ...
    // http://localhost:8081/user_collections/create
    ...
    // http://localhost:8081/user_collections/update/:id
